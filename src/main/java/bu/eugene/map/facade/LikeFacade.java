...
public class LikeFacade {
        ...
        public ImageDto createLike(String token, Integer imageId) {
            return likeService.createLike(personService.getPersonFromToken(token),
                    imageService.getImageById(imageId));
        }

        public ImageDto deleteLike(String token, Integer likeId) {
